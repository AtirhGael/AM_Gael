...
import rectanglemap from '../../../components/images/Rectangle-Map.svg'
...
import trashimage from '../../../components/images/Rectangle 360.svg'
import placeholderagentimage from '../../../components/images/Ellipse 110.svg'
import onthewaygreencircle from '../../../components/images/Ellipse 385.svg'
...
const ActiveRequest = () => {
  ...
  return (
    <div>
        <Row>
            <Col xs={12} sm={12} md={12} lg={9} className='active-agents-main-col'>
                <Bread
                prevPage={'Agent Management'}
                mainPage={'Active Management'}
                />
                ...
                <div className='active-agent-info-div'>
                    ...
                    <div className='active-agent-div-inner-left-div'>
                        ...
                        <div>
                            <p className='active-agent-booking-type-paragraph'>Booking Type</p>
            ...
            <Col xs={12} sm={12} md={12} lg={3} className='active-agents-side-col' >
