...
const Navigation = ({showSideNav, setShowSideNav, page, setPage}) => {
    ...
    const[adminManagementButtonDropdownVisible, setIsAdminManagementButtonDropdownVisible] = useState(false)
    ...
    <div className='side-navigation-block'>
        ...
        <div className='navigation-links-div'>
            ...
            <div>
                ...
                <div>
                <button className={`navigation-button ${(page === '/admin-management') ? 'active-navigation' : ''}`} onClick={() => {
                    setIsAdminManagementButtonDropdownVisible(!adminManagementButtonDropdownVisible)
                    navigatingFunction('/admin-management')
                    }}>
                    <div className='each-navigation-grid-div'>
                        <img src={peopleicon} alt='Home Icon' className='navigation-icon'></img>
                        <span>Admin  Management {adminManagementButtonDropdownVisible ? <img src={navbuttondropdownicon} alt='' className='navbuttondropdonwicon'></img> : <img src={navbuttondropupicon} alt='' className='navbuttondropdonwicon'></img>}</span>
                    </div>
                </button>
            </div>
                {adminManagementButtonDropdownVisible ? 
                    <div className='dropdown-buttons-div'>
                        <div>
                            <button className={`navigation-button ${(page === '/admin-management/add-admin') ? 'active-navigation' : ''}`} onClick={() => navigatingFunction('/admin-management/add-admin')}>
                                <div className='each-navigation-grid-div'>
                                    <span>Add Admin</span>
                                </div>
                            </button>
