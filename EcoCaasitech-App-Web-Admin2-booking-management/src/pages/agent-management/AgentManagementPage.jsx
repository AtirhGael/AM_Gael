            ...
            <Grid item xs={12} sm={12} md={12} lg={9}>
                ...
                <div className='agent-listing-div'>
                    <div className='agent-listing-upper-div'>
                        ...
                        <button className='agent-listing-see-all-button' onClick={() => {setPage('/agent-management/agent-listing'); navigate('/agent-management/agent-listing')}}>See all</button>
                    </div>
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        <TableRow>
                                            ...
                                            <TableCell>TA01234567</TableCell>
