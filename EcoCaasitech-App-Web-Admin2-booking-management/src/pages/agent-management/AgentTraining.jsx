                    ...
                    <Table className='agent-listing-table' aria-label='Agent Listing Table'>
                        ...
                        <TableBody className='agent-listing-table-body'>
                            <TableRow className='agent-training-body-row'>
                                ...
                                <TableCell>
                                <div className='agent-listing-row-status-div training-table-status-div'>3 days left</div>
                                </TableCell>
                                <TableCell>CTA01234567</TableCell>
                                <TableCell>N/A</TableCell>
                                <TableCell>
                                <div className='agent-listing-row-status-div'>Active</div>
                                </TableCell>
                                <TableCell>
                                <ThreeDotsDropdown
                            ...
                            <TableRow className='agent-training-body-row'>
                                ...
                                <TableCell>
                                <div className='agent-listing-row-status-div training-table-status-div'>Completed</div>
                                </TableCell>
                                <TableCell>CTA01234567</TableCell>
                                <TableCell>N/A</TableCell>
                                <TableCell>
